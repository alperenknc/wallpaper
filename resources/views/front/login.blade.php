...
<body>
    ...
    <div style="height: 100vh;">
      <video autoplay="true" loop="" muted style="position: absolute;width:100%;">
    ...
    <div class="wrapper fadeInDown">
      <div id="formContent">
        ...
        <div class="fadeIn first">
          <img style=" padding: 2rem; width: 150px;" src="{{ asset('assets/img/user.png') }}" id="icon" alt="User Icon" />
        </div>
        @if ($errors->any())
